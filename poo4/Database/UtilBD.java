...
public class UtilBD {
	...
	public static void initBD() {
		try {
			...
			Alertas.erro("Nao consegui criar o banco!");
		}
	}
	...
	private static void criarConta(Statement stm) throws SQLException {
		...
		stm.executeUpdate("CREATE TABLE Conta (" + 
				"	numConta varchar(5) NOT NULL unique PRIMARY KEY, " + 
				"   numAgencia varchar(5), " +
				"	foreign key (numAgencia) references Agencia(numAgencia) on delete cascade);");
	...
	private static void criarCCorrente(Statement stm) throws SQLException {
		...
		stm.executeUpdate("CREATE TABLE CCorrente (" + 
				"	NumCorrente varchar(5) NOT NULL primary KEY, " + 
				"	numConta varchar(5) NOT NULL, " + 
				"	Saldo double, " +  
	...
	private static void criarCPoupanca(Statement stm) throws SQLException {
		...
		stm.executeUpdate("CREATE TABLE CPoupanca (" + 
				"	NumPoupanca varchar(5) NOT NULL primary KEY, " + 
				"	numConta varchar(5) NOT NULL, " + 
				"	Saldo double, " +  
				"	foreign key (numConta) references Conta(numConta) on delete cascade);");
		stm.executeUpdate("INSERT INTO CPoupanca VALUES ('00', '89460', null)");
		stm.executeUpdate("INSERT INTO CPoupanca VALUES ('21644', '25107', '500.00')");
		stm.executeUpdate("INSERT INTO CPoupanca VALUES ('01', '74062', null)");
	}
	...
	private static void criarFCliente(Statement stm) throws SQLException {
		...
		stm.executeUpdate("CREATE TABLE FCliente (" + 
				"	numConta varchar(5) NOT NULL unique, " + 
